...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/index", "/Login", "/Register", "/**/*.css", "/**/*.js", "/img/**", "/SVG/**").permitAll()
                .antMatchers("/allExam", "/allStudent").hasAnyAuthority("1", "2")
                .antMatchers("/allTeacher", "/allUser").hasAuthority("1")
                .antMatchers("/allQuestions").hasAuthority("2")
                .antMatchers("/TakeExam").hasAuthority("3")
